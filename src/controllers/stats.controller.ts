...
export class StatsController {
  ...
  static async getStatsBarbero(req: Request, res: Response): Promise<void> {
    try {
      ...
      const mes = req.query.mes  ? parseInt(req.query.mes  as string) : ahora.getUTCMonth() + 1;
      const año = req.query.year ? parseInt(req.query.year as string) : ahora.getUTCFullYear();
